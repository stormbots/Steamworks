 ...
 *
 */
public class ShooterSequenceVision extends CommandGroup {

    public ShooterSequenceVision() {
        // Add Commands here:
    	...
    	//Set up the turret and shooter
    	addSequential(new VisionBoilerWaitForValidTarget(),2);
    	addSequential(new TurretSetTargetAngleFromVision(),1);

    	addSequential(new VisionBoilerWaitForValidTarget(),.2);
    	addSequential(new TurretSetTargetAngleFromVision(),.5);
    	
    	addSequential(new VisionBoilerWaitForValidTarget(),.2);
    	
    	//Shooter Sequence
    	addParallel(new ShooterVisionSetRPM());
